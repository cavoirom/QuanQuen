...
public class DataTest {
	...
	public static void main(String[] args) {
		...
		String[] categories = new String[] { "Quán cà phê", "Quán Internet",
		...
		// Setup Group
		 ...
		 for (int i=0; i<usernames.length; i++){
			 Member memberAdd = new Member(usernames[i], usernames[i],
					 usernames[i] + "@yahoo.com", new Date(), group, true);
			 group.addMember(memberAdd);
		 }
