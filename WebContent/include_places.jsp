<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String strType = (String)request.getParameter("category");
	if(strType != null){
		strType = new String(strType.getBytes("8859_1"),"UTF-8");
	}else{
		strType = "Không tìm thấy";
	}
%>
<div id="content">
	<h3 class="mark">Thể loại: <%=strType%></h3>
	<a href="places.jsp?category=Cà Phê">adsf</a>
	<div id="quanquen_first">
		<div id="topplace">
			<div id="numbertopplacebox">
				...
				<input type="button" class="numberbox" value="2" onClick="slideshowcategory.change(this.value)"/>
				<input type="button" class="numberbox" value="3" onClick="slideshowcategory.change(this.value)"/>
				<input type="button" class="numberbox" value="4" onClick="slideshowcategory.change(this.value)"/>
				<input type="button" class="numberbox" value="5" onClick="slideshowcategory.change(this.value)"/>
				<input type="button" class="numberbox" value="6" onClick="slideshowcategory.change(this.value)"/>
				<input type="button" class="numberbox" value="7" onClick="slideshowcategory.change(this.value)"/>
			</div>
